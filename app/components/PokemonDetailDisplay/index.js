...
import { PokemonTypeButton, PokemonProfileRow, PokemonStatsCol, PokemonTypeCol } from './styles';

import CharactersCard from 'components/CharactersCard';

const { Text } = Typography;

function PokemonDetailDisplay({ pokemonDetail, doFavPokemon, doUnFavPokemon, dataPokemonModal }) {
        ...
        <Row span={24} gutter={15}>
          ...
          <Col span={12}>
            <PokemonTypeCol span={24}>
              {pokemonDetail.data && pokemonDetail.data.types &&
                renderType(pokemonDetail.data.types)}
            </PokemonTypeCol>

            <PokemonStatsCol span={24}>
              {pokemonDetail.data && pokemonDetail.data.stats &&
              ...
              <PokemonProfileRow span={24}>
                <Col col={24}>
                  ...
                  <div>
                    <span>Height :</span>
                    &nbsp;&nbsp;
                    {pokemonDetail.data && pokemonDetail.data.height && pokemonDetail.data.height} m
                  </div>
                  <div>
                    <span>Weight :</span>
                    &nbsp;&nbsp;
                    {pokemonDetail.data && pokemonDetail.data.weight && pokemonDetail.data.weight} kg
                  </div>
                  <div>
                    <span>Base Experience :</span>
                    &nbsp;&nbsp;
                    {pokemonDetail.data && pokemonDetail.data.base_experience &&
